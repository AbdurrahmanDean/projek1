...
@section('konten')
    ...
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form class="row justify-content-center" action="{{route('jabatan.update',[$jabatan->id])}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group col-lg-12">
                        <label>Nama Jabatan</label>
                        <input type="text" class="form-control" value="{{$jabatan->nama_jabatan}}" name="nama" placeholder="Masukkan Nama Jabatan" required>
                    </div>
