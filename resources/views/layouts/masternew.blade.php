                    ...
                    <div class="s-header__navbar-row">
                        <div class="s-header__navbar-row-col">
                            ...
                            <div class="s-header__logo">
                                <a href={{url("indexnew")}} class="s-header__logo-link">
                ...
                <nav class="s-header__nav js__scrollbar">
                    <div class="container-fluid">
                        ...
                        <ul class="list-unstyled s-header__nav-menu">
                            <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider" href={{url("contactnew")}}>Contacts</a></li>
                            <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider" href={{url("aboutnew")}}>About</a></li>
                        </ul>
                        <!-- End Menu List -->
                    </div>
                </nav>
                    ...
                    <div class="row">
                        <div class="col-sm-2 g-margin-b-20--xs g-margin-b-0--md">
                            <ul class="list-unstyled g-ul-li-tb-5--xs g-margin-b-0--xs">
                                <li><a class="g-font-size-15--xs g-color--white-opacity" href={{url("indexnew")}}>Home</a></li>
                                <li><a class="g-font-size-15--xs g-color--white-opacity" href={{url("contactnew")}}>About</a></li>
                                <li><a class="g-font-size-15--xs g-color--white-opacity" href={{url("contactnew")}}>Contact</a></li>
                            </ul>
                        </div>
                        <div class="col-sm-2 g-margin-b-20--xs g-margin-b-0--md">
                            <ul class="list-unstyled g-ul-li-tb-5--xs g-margin-b-0--xs">
            ...
            <div class="container g-padding-y-50--xs">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-xs-12 g-text-left--xs">
                        <p class="g-font-size-14--xs g-margin-b-0--xs g-color--white-opacity-light"><a href={{("index")}}>Megakit</a> Theme Powered by: <a href="http://www.keenthemes.com/">KeenThemes.com</a></p>
                    </div>
                </div>
            </div>
            <!-- End Copyright -->
