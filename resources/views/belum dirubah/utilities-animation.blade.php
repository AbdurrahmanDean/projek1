...
@section('judul','utilities-animation')
@section('konten')
<!DOCTYPE html>
<html lang="en">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href={{url("utilities-animation.html")}}>Animations</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    href={{asset("https://getbootstrap.com/docs")}}>Bootstrap Documentation</a> page. The custom utilities
